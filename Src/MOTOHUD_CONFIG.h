...
#define WHEEL_CIRCUMFERENCE     1.85	//wheel circumference in meters
...
#define STEPPER_MIN_DELAY   		12		//bigger value slows down the motor (16-30), too low can make it lose steps
#define STEPPER_ACCELERATION		2		//lower value makes motor accelerate slower (1-3)
#define STEPPER_DECCELERATION		500		//lower value makes motor stop faster (100-500)
